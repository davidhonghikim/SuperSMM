...
export default {
  ...
  "baseUrl": "/SuperSMM/",
  "organizationName": "davidhonghikim",
  "projectName": "SuperSMM",
  "onBrokenLinks": "throw",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/davidhonghikim/SuperSMM/tree/main/docs_src/"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 SuperSMM. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
